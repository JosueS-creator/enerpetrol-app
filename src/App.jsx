      ...
      <div className="w-full max-w-md min-h-screen flex flex-col relative" style={{ background: bg }}>
        ...
        {mostrarInvitar && perfil && (
          <div className="fixed inset-0 z-50 flex items-end justify-center px-4 pb-24"
            ...
            <div className="w-full max-w-sm rounded-2xl overflow-hidden"
              style={{ background: card, boxShadow: '0 -8px 40px rgba(0,0,0,0.3)' }}
              ...
              <div className="px-5 pt-5 pb-4" style={{ background: `linear-gradient(135deg, ${NAVY} 0%, #1A3D6B 100%)` }}>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    {REFERIDOS_ACTIVO() ? (
                      <p className="text-xs mt-0.5" style={{ color: GREEN_LIGHT }}>
                        🎉 Gana 1 Enermoneda por cada referido — hasta el 15 de agosto
                      </p>
                    ) : (
                  ...
                  <button onClick={() => setMostrarInvitar(false)}
              ...
              <div className="px-5 py-5">
                {REFERIDOS_ACTIVO() && (
                  <>
                    ...
                    <div className="flex items-center gap-2 rounded-xl border px-4 py-3 mb-4"
                      style={{ borderColor: GREEN, background: darkMode ? '#0D2818' : `${GREEN}0D` }}>
                    ...
                    <p className="text-xs mb-4" style={{ color: textMuted }}>
                      Tu amigo debe ingresar este codigo al registrarse. Cuando suba su primera factura, recibiras 1 Enermoneda automaticamente.
                    </p>
                  </>
                )}
                ...
                {!REFERIDOS_ACTIVO() && (
                  <p className="text-xs mb-4" style={{ color: textMuted }}>
                    Comparte la app Enerpetrol con tus amigos y familiares para que tambien disfruten de los descuentos en gasolineras de Honduras.
                  </p>
                )}

                <button onClick={compartirWhatsApp}
                  className="w-full rounded-xl py-3.5 text-sm font-bold flex items-center justify-center gap-2 text-white mb-3"
                ...
                <p className="text-[10px] text-center" style={{ color: textMuted }}>
                  Link: enerpetrol-app-git-main-enerpetrol.vercel.app
                </p>
              </div>
            </div>
          </div>
        ...
        {sesion && perfil && (
          <button
            ...
            style={{
              bottom: '72px',
              background: `linear-gradient(135deg, ${GREEN} 0%, #3D7A1F 100%)`,
              boxShadow: `0 4px 16px ${GREEN}60`,
              zIndex: 40,
            }}>
