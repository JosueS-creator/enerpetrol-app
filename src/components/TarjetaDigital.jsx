      ...
      <div className="relative rounded-2xl overflow-hidden"
        ...
        <div className="relative px-5 pt-6 pb-5"
          ...
          <svg className="absolute inset-0 w-full h-full" viewBox="0 0 340 200" preserveAspectRatio="none" fill="none">
            ...
            <line x1="0" y1="200" x2="200" y2="0" stroke={GREEN} strokeWidth="0.8" opacity="0.12" />
            <line x1="40" y1="200" x2="240" y2="0" stroke={GREEN} strokeWidth="0.8" opacity="0.08" />
            <line x1="80" y1="200" x2="280" y2="0" stroke={GREEN} strokeWidth="0.8" opacity="0.06" />
          </svg>
          ...
          <div className="relative z-10 flex items-center justify-between mb-6">
            ...
            <span className="text-[9px] uppercase tracking-widest font-semibold px-2 py-1 rounded-full"
