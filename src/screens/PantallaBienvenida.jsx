  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative z-10">
        ...
        <p className="text-sm uppercase tracking-[0.18em] text-center mb-2 font-semibold" style={{ color: NAVY, opacity: 0.75 }}>
          Conectamos consumidores
        </p>
        <p className="text-sm uppercase tracking-[0.18em] text-center" style={{ color: GREEN, opacity: 0.9, fontWeight: 700 }}>
          Generamos ahorro
        </p>
      ...
      <div className="w-full max-w-xs relative z-10 space-y-3">
        ...
        <div className="flex justify-center gap-6">
          ...
          <a href="mailto:supportenerpetrol@gmail.com" className="text-xs font-medium" style={{ color: '#5C6870' }}>
