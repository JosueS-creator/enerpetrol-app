...
export default function VistaAdmin() {
  ...
  async function descargarReporteMensual() {
    ...
    const detalle = [
      ['Fecha', 'Cliente', 'Numero de tarjeta', 'Galones', 'Estado', 'Enermonedas otorgadas', 'Costo en Enermonedas (L)'],
      ...lista.map((f) => [
                ...
                <div className="flex items-start justify-between gap-2">
                  ...
                  <div className="flex gap-1">
                    <button onClick={() => toggleExcluirReferidos(c)}
                      className="p-1.5 rounded border flex-shrink-0 text-[10px] font-semibold px-2"
                      style={{
                        borderColor: c.excluido_referidos ? GREEN : '#EF4444',
                        color: c.excluido_referidos ? GREEN : '#EF4444'
                      }}>
              ...
              <div key={r.id} className="rounded-xl border p-3" style={{ borderColor: BORDER, background: CARD }}>
                <div className="flex items-start justify-between gap-2">
                  ...
                  <span className="text-[10px] font-bold px-2 py-1 rounded-full flex-shrink-0"
                    style={{
                      background: r.punto_otorgado ? `${GREEN}18` : '#EDF0F3',
                      color: r.punto_otorgado ? '#4A9123' : TEXT_MUTED
                    }}>
